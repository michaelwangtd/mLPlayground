...
if __name__ == '__main__':
    ...
    inFilePath = inout.getDataPathTimeseries('AirPassengers.csv')

    data = pd.read_csv(inFilePath, header=0, parse_dates=['Month'], date_parser=date_parser, index_col=['Month'])
